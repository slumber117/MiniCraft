...
public enum Block {
    ...
    TANZANITE_ORE(true, 3, 5.0f, 15.0f, "tanzanite_ore"),
    SILVER_ORE(true, 3, 5.0f, 8.0f, "silver_ore"),
    NICKEL_ORE(true, 3, 5.0f, 7.0f, "nickel_ore"),
    PLATINUM_ORE(true, 3, 8.0f, 12.0f, "platinum_ore"),
 
    DIAMOND_ORE(true, 4, 30.0f, 20.0f, "diamond_ore"),
    EMERALD_ORE(true, 5, 25.0f, 18.0f, "emerald_ore"),
    RUBY_ORE(true, 5, 25.0f, 18.0f, "ruby_ore"),
    TOPAZ_ORE(true, 5, 20.0f, 15.0f, "topaz_ore"),
    AQUAMARINE_ORE(true, 5, 20.0f, 15.0f, "aquamarine_ore"),
    ...
    URANIUM_ORE(true, 6, 45.0f, 45.0f, "uranium_ore"),
    NEPTUNIUM_ORE(true, 6, 45.0f, 45.0f, "neptunium_ore"),
 
    TUNGSTEN_ORE(true, 4, 10.0f, 12.0f, "tungsten_ore"),
    TITANIUM_ORE(true, 3, 10.0f, 12.0f, "titanium_ore"),

    // ── Rare Earth Ores (Tier 1, 12-30) ──────────────────────────────────
    XANTHIOSITE_ORE(true, 12, 4.0f, 5.0f, "xanthiosite_ore"),
    MONAZITE_ORE(true, 13, 180.0f, 600.0f, "monazite_ore"),
    BASTNAESITE_ORE(true, 14, 200.0f, 650.0f, "bastnaesite_ore"),
    XENOTIME_ORE(true, 15, 220.0f, 700.0f, "xenotime_ore"),
    LOPARITE_ORE(true, 16, 240.0f, 750.0f, "loparite_ore"),
    TANTALITE_ORE(true, 17, 260.0f, 800.0f, "tantalite_ore"),
    VANADINITE_ORE(true, 18, 280.0f, 850.0f, "vanadinite_ore"),
    GADOLINIUM_ORE(true, 19, 300.0f, 900.0f, "gadolinium_ore"),
    TERBIUM_ORE(true, 20, 320.0f, 950.0f, "terbium_ore"),
    DYSPROSIUM_ORE(true, 21, 340.0f, 1000.0f, "dysprosium_ore"),
    ...
    PRASEODYMIUM_ORE(true, 26, 480.0f, 1700.0f, "praseodymium_ore"),

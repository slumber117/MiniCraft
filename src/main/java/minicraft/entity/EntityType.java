...
public enum EntityType {
    ...
    FIRE_DRAGON("Fire Dragon", Category.MONSTER, 7000f, 4.0f, 3.0f, "Sky / Volcanic"),
    FIRE_DEMON("Fire Demon", Category.MONSTER, 20000f, 2.5f, 5.0f, "Deepest Core / Hell"),
    EARTH_DRAGON("Earth Dragon", Category.MONSTER, 12000f, 2.4f, 3.0f, "Sky / Forest"),
    ICE_DRAGON("Ice Dragon", Category.MONSTER, 10000f, 2.4f, 3.0f, "Sky / Snow Mountains"),
    GOLD_DRAGON("Gold Dragon", Category.MONSTER, 2000f, 2.4f, 3.0f, "Sky"),
    ONYX_DRAGON("Onyx Dragon", Category.MONSTER, 15000f, 2.4f, 3.0f, "Sky / Forest"),
    ...
    FOREST_CRAWLER("Forest Crawler", Category.MONSTER, 4000f, 3.0f, 5.0f, "Forest"),
    ICE_GOLEM("Ice Golem", Category.MONSTER, 10000f, 2.4f, 3.0f, "Tundra"),
    ICE_BEAST("Ice Beast", Category.MONSTER, 30000f, 2.4f, 3.0f, "Tundra"),
    ARBORIUS("Arborius", Category.MONSTER, 50000f, 3.5f, 5.0f, "Deep Forest"),
    ...
    SOLAR_BEAM("Solar Beam", Category.NPC, 1f, 0.5f, 0.5f, "Weapon"),
